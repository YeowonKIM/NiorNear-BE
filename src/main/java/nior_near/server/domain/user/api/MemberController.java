...
public class MemberController {
    ...
    @GetMapping
    BaseResponseDto<MyMemberResponseDto> getMyProfile(@AuthenticationPrincipal UserDetails userDetails) {

        return BaseResponseDto.onSuccess(memberService.getMyProfile(userDetails.getUsername()), ResponseCode.OK);
    }

    @GetMapping("/payments")
    BaseResponseDto<List<MyPaymentSummaryResponseDto>> getMyPaymentSummary(@AuthenticationPrincipal UserDetails userDetails) {

        return BaseResponseDto.onSuccess(memberService.getMyPaymentSummary(userDetails.getUsername()), ResponseCode.OK);
    }
}
