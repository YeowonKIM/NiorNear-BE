...
import nior_near.server.global.auth.handler.OAuth2SuccessHandler;
import nior_near.server.global.auth.jwt.JwtAuthenticationFilter;
...
public class WebSecurityConfiguration {
    ...
    private String[] permitAllUri = {"/", "/api/v1/auth/**", "/oauth2/**", "/h2-console/**", "/regions/**", "/home/**", "/profile-check","/health"};
